...
if 'PURR' in args or 'PURR' not in args:
    split_spritesheet( '8bpp/PURR-x1-8bpp.png' , 5, 1)
    split_spritesheet('32bpp/PURR-x1.png'      , 5, 1)
    
    split_spritesheet( '8bpp/PURR-x4-8bpp.png' , 5, 1)
    split_spritesheet('32bpp/PURR-x4.png'      , 5, 1)
