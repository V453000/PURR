'''
This script has been written by Vaclav V453000 Benc for the purposes of converting 32bpp images to indexed images using OpenTTD's DOS palette.

It can be redistributed and/or modified according to the terms of the GNU General Public License as published by the Free Software Foundation, version 2.
This script is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
See the GNU General Public License for more details. You should have received a copy of the GNU General Public License v2 along with RGBA-EATER or BRIX Realism Is XXXX. If not, see http://www.gnu.org/licenses/ .

I hope this script will prove to be as useful for you as it has been for me!

You can find info about how to use the script at:

http://www.dev.openttdcoop.org/projects/brix/wiki/rgba-eater/
